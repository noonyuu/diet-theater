          ...
          <table className="table mx-auto w-full rounded-b-none bg-white">
            <thead className="">
              <tr className="border-gray-100 text-center text-base">
                ...
                <th className="hidden w-1/6 text-xs text-gray-400 lg:ta jble-cell lg:text-xl">
                  政党
                </th>
                ...
                return (
                  <tr key={keys} className="border-gray-100 text-center">
                    ...
                    <td className="rounded-br-xl p-0 px-1 py-3 text-xs lg:text-lg">
                      <button
                        type="button"
                        className="mx-auto flex items-center rounded-md border-2 border-green-500 bg-green-100 px-1 py-1 text-xs text-green-500 lg:w-24 justify-center"
                        onClick={() => detail(keys)}
                      >
                        NOT CREATED
                      </button>
